      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
        ...
        <div className="flex gap-3 opacity-0 group-hover:opacity-100 transform translate-y-3 group-hover:translate-y-0 transition-all duration-500 delay-100">
          ...
          <motion.a
            ...
            className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/40 text-white rounded-full text-xs font-semibold flex items-center gap-1.5 hover:bg-primary hover:border-primary hover:text-primary-foreground transition-colors"
            whileHover={{ scale: 1.08 }}
            whileTap={{ scale: 0.95 }}
          >
